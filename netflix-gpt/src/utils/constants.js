...
export const NETFLIX_PLAY_ICON="https://miro.medium.com/v2/da:true/resize:fit:768/1*IDJ4x4E-bOypnEZdA5TGHQ.gif";
export const API_OPTIONS={
    method: 'GET',
    headers: {
      accept: 'application/json',
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI1MzRmMmJjOWMwYmNlNGNhMDhmMTc5ZThlYmJlYzVhOCIsIm5iZiI6MTcyMTk2NDkxMi45NzIxMTMsInN1YiI6IjY2YTI3NGJlMjY5YzI1ZTZmZjcyZTMxZCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.gFFu5GgTQ4F_H7rc9j9p-lKqKXLAJ9nFXcdC3x1hpWo'
    }
  };
